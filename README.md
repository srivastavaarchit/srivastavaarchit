...
```python
class ArchitSrivastava:
    def __init__(self):
        self.name       = "Archit Srivastava"
        self.role       = ["AI/ML Engineer", "Full-Stack Developer", "Team Leader"]
        self.location   = "Lucknow, India 🇮🇳"
        self.languages  = ["Python", "JavaScript", "Java", "HTML/CSS"]
        self.focus      = ["Computer Vision", "LLMs", "AI Agents", "Web Platforms"]
        self.projects   = ["Impact Trail", "Farm AI", "Heart Care AI", "RESQ System"]
